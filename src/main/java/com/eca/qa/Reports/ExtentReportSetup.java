...
{	
	...
	{
		sparkReport = new ExtentSparkReporter(System.getProperty("user.dir") + "/ECAExtentResults/ECAExtentReport" + TestUtility.getSystemDate() + ".html");
